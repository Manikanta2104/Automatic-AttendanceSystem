...
class Face_Recognition:
    def __init__(self,root):
        ...
        img_top=Image.open(r"C:\Users\manik\OneDrive\Desktop\face-reconigation\college_image\face_detector2.jpg")
        ...
        img_bottom=Image.open(r"C:\Users\manik\OneDrive\Desktop\face-reconigation\college_image\scanning_image.png")
    ...
    def mark_attendance(self,i,r,n,d):
        with open("attendance_system.csv","r+",newline="\n") as f:
    ...
    def face_recog(self):
        ...
        def recognize(img,clf,faceCascade):
            coord=draw_boundray(img,faceCascade,1.1,10,(255,55,255),"Face",clf)
            return img
